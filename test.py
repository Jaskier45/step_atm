...
def get_answer(browser):
    ...
    for select in ['#robotCheckbox', '#robotsRule', '.btn']:
...
def wait_spinner(browser):
    ...
    for txt in ('подождите, не покидайте страницу',
        ...
        driver_wait.until_not(elem_loc((By.XPATH, f'//span[contains(text(),{txt})]')))
...
try:
    ...
    # отправляем решение
    url = 'https://stepik.org/lesson/165493/step/7?unit=140087'
